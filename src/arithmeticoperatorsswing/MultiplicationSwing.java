...
public class MultiplicationSwing extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MultiplicationSwing frame = new MultiplicationSwing();
	...
	public MultiplicationSwing() {
		...
		btnMultiply.setBounds(119, 133, 136, 37);
